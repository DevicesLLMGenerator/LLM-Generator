        ...
        6. Example : If the user Quesiton is "Summarize reviews of Github Copilot"
                ...
                6.3 IMPORTANT : if any particular Aspect "Code Generation" in user question:
                    ...
                    IMPORTANT : TOTAL Should always be the Overall Sentiment of a product family/Product.
                        ...
                        IMPORTANT : Here, important thing to notice is in the "TOTAL" of aspect column, %Code Generation% is not added as it is Overall sentiment. It should be the Overall sentiment of CoPilot for Mobile in this case.
...
def get_conversational_chain_aspect_wise_detailed_summary():
    ...
    try:
        ...
        IMPORTANT: Use only the data provided to you and do not rely on pre-trained documents.
          ...
          Generate acurate response only, do not provide extra information.Following is the previous conversation from User and Response, use it to get context only:""" + str(history) + """\n
        ...
        prompt_template = """
                ...
                IMPORTANT : User won't exactly mention the exact Geography Names, Product Names, Product Families, Data Source name, Aspect names. Please make sure to change/correct to the values that you know from the context and then provide SQL Query.
                   ...
                   9. IMPORTANT NOTE :
                    ...
                    10. Review count mix/ Review count Percentage of a product by aspect:
                    ...
                    All these comparision questions meant to provide the aspect wise sentiment comparison. When user seeks "Compare different versions of copilot", the user want "Compare aspect wise sentiment of different versions of copilot"
        ...
        prompt_template = """
            ...
            Your response should follow the below templates, based on input data:
                ...
                2. Product Family wise summary -
                    ...
                    - Copilot for Mobile: The net sentiment for reviews of Copilot for Mobile is x, based on y reviews. (Mention 'Driving Net sentiment High' if net sentiment for this Product Family is greater than {overall_net_sentiment}, else mention 'Driving Net sentiment Low')
                    ...
                    - Copilot: The net sentiment for reviews of Copilot is x, based on y reviews. (Mention 'Driving Net sentiment High' if net sentiment for this Product Family is greater than {overall_net_sentiment}, else mention 'Driving Net sentiment Low')
                    ...
                    - Copilot in Windows 11: The net sentiment for reviews of Copilot in Windows 11 x , based on y  reviews. (Mention 'Driving Net sentiment High' if net sentiment for this Product Family is greater than {overall_net_sentiment}, else mention 'Driving Net sentiment Low')
                    ...
                    - Copilot Pro: The net sentiment for reviews of Copilot Pro is x, based on y reviews. (Mention 'Driving Net sentiment High' if net sentiment for this Product Family is greater than {overall_net_sentiment}, else mention 'Driving Net sentiment Low')
                    ...
                    - Github Copilot: The net sentiment for reviews of Github Copilot is x, based on y reviews. (Mention 'Driving Net sentiment High' if net sentiment for this Product Family is greater than {overall_net_sentiment}, else mention 'Driving Net sentiment Low')
                    ...
                    - Microsoft Copilot: The net sentiment for reviews of Microsoft Copilot is x, based on y reviews. (Mention 'Driving Net sentiment High' if net sentiment for this Product Family is greater than {overall_net_sentiment}, else mention 'Driving Net sentiment Low')
                    ...
                    - Copilot for Security: The net sentiment for reviews of Copilot for Security is x, based on y reviews. (Mention 'Driving Net sentiment High' if net sentiment for this Product Family is greater than {overall_net_sentiment}, else mention 'Driving Net sentiment Low')
                    ...
                    Copilot for Microsoft 365: The net sentiment for reviews of Copilot for Microsoft 365 is x, based on y reviews. (Mention 'Driving Net sentiment High' if net sentiment for this Product Family is greater than {overall_net_sentiment}, else mention 'Driving Net sentiment Low')
...
# Function to handle user queries using the existing vector store
def query_detailed_summary(dataframe_as_dict,user_question, vector_store_path="faiss_index_CopilotSample"):
    try:
        embeddings = AzureOpenAIEmbeddings(azure_deployment="MV_Agusta")
        vector_store = FAISS.load_local(vector_store_path, embeddings, allow_dangerous_deserialization=True)
...
def get_conversational_chain_generic():
    ...
    try:
        ...
        3. Respond accurately based on the provided Copilot Products Data only. Following is the previous conversation from User and Response, use it to get context only:""" + str(history) + """\n
                Use the above conversation chain to gain context if the current prompt requires context from previous conversation.\n
        Context:\n {context}?\n
        Question: \n{question}\n
